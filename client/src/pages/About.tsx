...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      {/* Hero Section */}
      <div className="pt-20 bg-gradient-to-br from-orange-50 via-orange-100/50 to-white relative overflow-hidden transition-colors duration-300 dark:from-slate-950 dark:via-slate-900/60 dark:to-slate-950">
        <div className="absolute top-0 left-0 w-full h-full">
          <div
            className="absolute top-1/4 right-1/4 w-64 h-64 bg-orange-200/30 rounded-full blur-3xl animate-pulse dark:bg-orange-500/10"></div>
          <div
            className="absolute bottom-1/4 left-1/4 w-48 h-48 bg-orange-300/20 rounded-full blur-2xl animate-pulse delay-1000 dark:bg-orange-400/10"></div>
        </div>

        <div className="section-container py-20 relative z-10">
          <div className="text-center animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6 dark:text-white">
              About <span className="gradient-text">Pwani Innovation Week</span>
            </h1>
      ...
      <section className="py-20 bg-white border-t border-orange-100 transition-colors duration-300 dark:bg-slate-950 dark:border-orange-500/20">
        ...
        <div className="section-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {features.map((feature, index) => (
              <div
                key={index}
                className="text-center p-6 rounded-xl bg-gradient-to-br from-orange-50 to-white border border-orange-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 animate-fade-in dark:from-slate-900 dark:to-slate-950 dark:border-orange-500/20"
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2 dark:text-white">{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="animate-fade-in">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-[#F97316] dark:bg-slate-900">
                  <p className="text-lg text-gray-700 leading-relaxed dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 animate-fade-in delay-300">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-orange-100/50 to-transparent p-6 rounded-xl dark:from-slate-800/40">
      ...
      <section className="py-20 bg-gradient-to-br from-[#F97316]/5 to-orange-100/30 transition-colors duration-300 dark:from-slate-950 dark:via-slate-900/60 dark:to-slate-950">
        <div className="section-container">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 dark:text-white">Our Impact in Numbers</h2>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              <div
                key={index}
                className="text-center p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 animate-fade-in dark:bg-slate-900"
              ...
              >
                ...
                <p className="text-gray-600 font-medium dark:text-gray-300">{achievement.label}</p>
              </div>
            ))}
          </div>
        </div>
