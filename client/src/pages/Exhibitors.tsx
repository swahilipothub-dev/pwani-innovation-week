...
const Exhibitors = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setServerMessage(data?.message || 'Exhibitor created successfully');
      setSubmitted(true);
      resetForm();
    } catch (err: any) {
      ...
      <section className="pt-24 pb-12 bg-gradient-to-br from-purple-50 via-purple-100/50 to-white text-center">
        <div className="section-container">
          ...
          <p className="text-xl text-gray-700 max-w-xl mx-auto">
            Register your business to participate in PIW 2025 as an exhibition.
          </p>
        </div>
      </section>
