      ...
      <div className="bg-[#fbf9f6] py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl bg-[#0a1628]">
            ...
            <div className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full border-[18px] border-[#F97316]/15" />
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-8 px-8 py-12 sm:px-12 sm:py-14">
              ...
              <a
                ...
                download
                className="flex-shrink-0 inline-flex items-center gap-2 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-sm px-6 py-3.5 rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-[#F97316]/25 hover:-translate-y-0.5 whitespace-nowrap"
              >
