...
const About = () => {
  ...
  return (
    <section id="about" className="bg-gradient-to-b from-white to-[#fffaf5]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-28">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div ref={copy.ref} className="w-full lg:w-1/2 space-y-8">
            <div>
              <span style={fadeUp(copy.inView, 0)} className="inline-block bg-[#F97316]/10 border border-[#F97316]/20 text-[#F97316] text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-4">
                About PIW 2026
              </span>
            ...
            <div ref={statsRow.ref} className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 pt-2">
              {stats.map((s, i) => (
                <div key={s.label} style={scaleIn(statsRow.inView, i * 80)} className="text-center p-4 rounded-2xl bg-white border border-gray-200 shadow-[0_10px_24px_rgba(2,8,23,0.05)]">
