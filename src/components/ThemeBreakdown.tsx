...
const themeBreakdown = [
  {
    ...
    tone: "bg-[#f4e5df] text-[#F97316] border-[#F97316]",
  },
  {
    title: "Youth",
    ...
    tone: "bg-[#dceefe] text-[#38a6df] border-[#38a6df]",
  },
  {
    title: "Innovation",
    ...
    tone: "bg-[#e5def8] text-[#5420b5] border-[#5420b5]",
  },
  {
    ...
    tone: "bg-[#d5e2fb] text-[#2458c4] border-[#2458c4]",
  },
];
    ...
    <section ref={theme.ref} className="relative overflow-hidden bg-[#eef4ff] py-20 md:py-24 border-y border-[#d9e5f7]">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 max-w-3xl">
          ...
          <h2 style={fadeUp(theme.inView, 100)} className="text-3xl font-black leading-tight text-gray-900 sm:text-5xl">
