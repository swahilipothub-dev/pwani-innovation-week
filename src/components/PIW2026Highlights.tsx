    ...
    <div className="home-section-frame bg-gradient-to-b from-[#f7fafe] to-[#f2f7fd]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        <div ref={whatHead.ref} className="max-w-2xl mb-10">
          <p style={fadeUp(whatHead.inView, 0)} className="text-xs text-[#F97316] font-bold uppercase tracking-[0.18em] mb-3">About the Event</p>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-2">
            {programmeDays.map((programmeDay, index) => (
              ...
              >
                ...
                <span className="relative block text-xs font-black uppercase tracking-[0.18em] text-[#FDBA74]">{programmeDay.day}</span>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div ref={dialogues.ref} className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
            <div style={fadeLeft(dialogues.inView)} className="lg:w-2/5 lg:sticky lg:top-28">
              <p className="text-xs text-[#F97316] font-bold uppercase tracking-[0.18em] mb-3">Before the Main Stage</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        <div ref={dealHead.ref} className="max-w-2xl mb-14">
          <p style={fadeUp(dealHead.inView, 0)} className="text-xs text-[#F97316] font-bold uppercase tracking-[0.18em] mb-3">Investment & Growth</p>
