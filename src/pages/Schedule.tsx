                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6">
                            {filteredSessions.map((session, index) => {
                                ...
                                // REMOVED: Speaker summary - the comma-separated list of all speaker names
                                            ...
                                            <div className="flex flex-col lg:flex-row gap-6">
                                                <div className="flex-1">
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                                        ...
                                                        {/* REMOVED: Display of speaker names row showing comma-separated list like "Charles Ayako, Ayubu Mohamed, Abdulrahman Ndegwa, Michael Onyango" */}
                              ...
                              <div className="flex items-center text-gray-600 dark:text-gray-300 sm:col-span-2">
                                ...
                                {speakerSummary}
                                                    ...
                                                    {hasSpeakers && (
                                                        <div className="mt-5">
                                                            <div className="rounded-2xl border border-orange-100 bg-gradient-to-br from-orange-50 via-white to-white p-5 shadow-inner dark:border-slate-800 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div className="flex-1 min-w-0">
                                                                                {getSpeakerDisplayText(speaker) && (
                                                                                    <p className="font-semibold text-gray-800 dark:text-gray-100 group-hover:text-[#F97316] truncate">
                                                                                        {getSpeakerDisplayText(speaker)}
                                                                                    </p>
                                                                                )}
                                                                                {hasMeaningfulText(speaker.title) && (
                                                                                    <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">{speaker.title}</p>
                                                                                )}
                                                                            ...
                                                                            <ArrowUpRight className="mt-1 h-4 w-4 text-gray-300 transition-colors group-hover:text-[#F97316] flex-shrink-0" />
                                                                        </button>
                                                                    ))}
                                                                </div>
                                                ...
                                                {/* REMOVED: Speakers panel from right side - now displayed below Reserve your spot button */}
                                                {/* {hasSpeakers && (
